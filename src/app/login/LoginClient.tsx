      ...
      <div className="flex flex-1 min-h-0 px-8 pb-8 gap-8">
        ...
        <aside className="w-80 shrink-0 flex flex-col">
          <div className="mb-5 shrink-0">
            <h1 className="text-3xl font-black mb-1" style={{ color: '#1C3060' }}>
              Store Selection
            </h1>
            <p className="text-[11px] font-bold tracking-widest uppercase" style={{ color: '#4A6FA5' }}>
          ...
          <div className="relative mb-4 shrink-0">
            ...
            <input
              ...
              style={{ border: '1px solid rgba(28,48,96,0.1)', color: '#1F2937' }}
            />
          </div>
              ...
              return (
                <button
                  ...
                  style={{
                    boxShadow: isSelected
                      ? '0 2px 10px rgba(28,48,96,0.15)'
                      : '0 1px 3px rgba(28,48,96,0.06)',
                    border: isSelected
                      ? '1.5px solid rgba(28,48,96,0.4)'
                ...
                >
                  ...
                  <div
                    ...
                    style={{ backgroundColor: isSelected ? '#1C3060' : '#F3F4F6' }}
                  >
                    {isSelected ? (
                      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} style={{ color: '#FFFFFF' }}>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div
            ...
            style={{ boxShadow: '0 8px 40px rgba(28,48,96,0.1), 0 2px 8px rgba(28,48,96,0.05)' }}
          >
